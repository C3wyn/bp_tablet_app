...
class APIService {
  ...
  static final IngredientsAPIService _ingredientsService =
  ...
  static Future<APIResponse<List<BPIngredient>?>> getIngredients() =>
      _handleErrors<List<BPIngredient>?>(_ingredientsService.getIngredients());
  static Future<APIResponse> addIngredient(String name) async =>
      _handleErrors(_ingredientsService.addIngredient(name));
  static Future<APIResponse> updateIngredient(BPIngredient ingredient,
          {required String name}) async =>
      _handleErrors(
          _ingredientsService.updateIngredient(ingredient, name: name));
  static Future<APIResponse> deleteIngredient(BPIngredient ingredient) async =>
      _handleErrors(_ingredientsService.deleteIngredient(ingredient));
  ...
  static Future<APIResponse> deleteCategory(BPCategory category) async =>
      _handleErrors(_categoriesService.deleteCategory(category));
  ...
  static Future<APIResponse> updateExtra(BPExtra,
          {required String name}) async =>
      _handleErrors(_extrasService.updateExtra(BPExtra, name: name));
  static Future<APIResponse> deleteExtra(BPExtra extra) async =>
      _handleErrors(_extrasService.deleteExtra(extra));

  static Future<APIResponse<t>> _handleErrors<t>(
